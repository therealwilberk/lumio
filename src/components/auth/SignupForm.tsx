          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {(pin !== "" || confirmPin !== "") && (
                  <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider font-bold mt-2 ml-1">
                    {pin === confirmPin && pin !== "" ? (
                      <Check className="h-3 w-3 text-green-500" />
                    ) : (
                      <div className="h-3 w-3 rounded-full border border-gray-300" />
                    )}
                    <span className={pin === confirmPin && pin !== "" ? 'text-green-600' : 'text-gray-400'}>
                      PINs Match
                    </span>
                  </div>
                )}
